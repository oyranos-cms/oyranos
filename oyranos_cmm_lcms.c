...
oyConnectorImage_s lcms_cmmIccSocket_connector = {
  oyOBJECT_CONNECTOR_S,0,0,0,
  {oyOBJECT_NAME_S, 0,0,0, "Img", "Image", "Image Socket"},
  "//image/manipulator", /* connector_type */
...
oyConnectorImage_s* lcms_cmmIccSocket_connectors[2]={&lcms_cmmIccSocket_connector,0};

oyConnectorImage_s lcms_cmmIccPlug_connector = {
  oyOBJECT_CONNECTOR_S,0,0,0,
  {oyOBJECT_NAME_S, 0,0,0, "Img", "Image", "Image Socket"},
  "//image/manipulator", /* connector_type */
...
oyConnectorImage_s* lcms_cmmIccPlug_connectors[2]={&lcms_cmmIccPlug_connector,0};
