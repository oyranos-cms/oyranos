...
/** \class Flmm_Tabs
 * Fl_Tabs with automatic pulldown menu.
 *
 * This class is derived from Fl_Tabs. It has the same API and 
 * usage. However, if the Tabs fill up, they won't be squezed 
 * together, but instead a pulldown menu is added which provides 
 * access to all Tabs at once.
 */
