...
int myMain( int argc, const char ** argv )
{
  ...
  oyjlUiHeaderSection_s sections[] = {
    ...
    {"oihs", "support",       NULL,  _("at:"),                 _("https://github.com/oyranos-cms/oyranos/issues")},
  ...
  /* type,   flags,                      o,  option,          key,      name,          description,                  help, value_name,         
    ...
    {"oiwi", 0,                          "j","json",          NULL,     _("JSON"),     _("Print JSON to std output."),NULL,NULL,
        oyjlOPTIONTYPE_NONE,     {0},                oyjlINT,       {.i=&json}},
    {"oiwi", 0,                          "y","yaml",          NULL,     _("YAML"),     _("Print YAML to std output."),NULL,NULL,
        oyjlOPTIONTYPE_NONE,     {0},                oyjlINT,       {.i=&yaml}},
    {"oiwi", 0,                          "m","xml",           NULL,     _("XML"),      _("Print XML to std output."),NULL,NULL,
