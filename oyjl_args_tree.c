    ...
    else
    {
      ...
      for(j = 0; j < n; ++j)
      {
        ...
        else
        {
          ...
          if(oyjlStringStartsWith(key, parent_id, 0))
...
#define ADD_SECTIONS( name_ ) \
  ...
  for(i = 0; i < ng; ++i)
  {
    ...
    for(j = 0; j < d; ++j)
    {
      ...
      int mandatory_index;
      if(!o) continue;
      mandatory_index = oyjlOption_MandatoryIndex_( o, g );
      num[0] = '\000';
      if(!o->key)
                                       ...
                                       const char          * date_description )
{
  oyjlUiHeaderSection_s s[] = {
    ...
    { "oihs", "manufacturer", NULL, "Kai-Uwe Behrmann", "" },
    { "oihs", "copyright", NULL, "Copyright © 2017-2024 Kai-Uwe Behrmann", NULL },
    { "oihs", "license", NULL, "MIT", "https://opensource.org/license/mit" },
    { "oihs", "url", NULL, "https://gitlab.com/beku/oyjl", NULL },
    { "oihs", "support", NULL, "https://www.gitlab.com/beku/oyjl/issues", NULL },
    { "oihs", "download", NULL, "https://gitlab.com/beku/oyjl/-/releases", NULL },
    { "oihs", "sources", NULL, "https://gitlab.com/beku/oyjl", NULL },
    { "oihs", "development", NULL, "https://gitlab.com/oyranos/oyranos", NULL },
    { "oihs", "oyjl_module_author", NULL, "Kai-Uwe Behrmann", "" },
    { "oihs", "documentation", NULL, "https://codedocs.xyz/oyranos-cms/oyranos/group__oyjl.html", documentation },
