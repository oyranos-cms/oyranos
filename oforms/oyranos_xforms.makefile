...
oyranos-xforms-fltk:	oyranos_xforms_fltk.cxx oyranos_forms_fltk.cxx oyranos_widgets_fltk.cxx oyranos_widgets_fltk.h
	c++ -Wall -g `pkg-config oyranos libxml-2.0 --libs --cflags` -I../../Entwickeln -I../../build_10.3  `fltk-config --ldflags --cxxflags` oyranos_xforms_fltk.cxx -o oyranos-xforms-fltk -pedantic -loyforms_fltk
