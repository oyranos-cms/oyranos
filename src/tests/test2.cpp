...
oyTESTRESULT_e testStringRun ()
{
  ...
  test_out = oyStringReplace( test, OY_INTERNAL, OY_STD, 0,0 );
  //fprintf(zout, "test %s \"%s\"\n", test, test_out);
  if( strstr(test_out, OY_STD ) != NULL )
  { PRINT_SUB( oyTESTRESULT_SUCCESS,
    "oyStringReplace(start)                             " );
  } else
  { PRINT_SUB( oyTESTRESULT_FAIL,
    "oyStringReplace(start)                             " );
  }
  ...
  test_out = oyStringReplace( test, "display.", "foo.", 0,0 );
  //fprintf(zout, "test %s \"%s\"\n", test, test_out);
  if( strstr(test_out, "foo" ) != NULL )
  { PRINT_SUB( oyTESTRESULT_SUCCESS,
    "oyStringReplace(middle)                            " );
  } else
  { PRINT_SUB( oyTESTRESULT_FAIL,
    "oyStringReplace(middle)                            " );
  }
  ...
  test_out = oyStringReplace( test, "display_name", "bar", 0,0 );
  //fprintf(zout, "test %s \"%s\"\n", test, test_out);
...
oyTESTRESULT_e testOptionsType ()
{
  ...
  char * reg_mod = oyStringReplace( reg, ".oydi", ".my", 0,0 );
  reg_mod = oyStringReplace( reg_mod, ".automatic", "", 0,0 );
