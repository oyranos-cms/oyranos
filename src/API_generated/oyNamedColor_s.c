/** @file oyNamedColor_s.c

   [Template file inheritance graph]
   +-> oyNamedColor_s.template.c
   |
   +-> Base_s.c
   |
 ...
 *  @brief   allocate a new NamedColor object
 */
OYAPI oyNamedColor_s * OYEXPORT
  oyNamedColor_New( oyObject_s object )
{
  oyObject_s s = object;
  oyNamedColor_s_ * namedcolor = 0;

  if(s)
    oyCheckType__m( oyOBJECT_OBJECT_S, return 0 )

  namedcolor = oyNamedColor_New_( s );
 ...
 *  @memberof oyNamedColor_s
 *  @brief   release and possibly deallocate a oyNamedColor_s object
 *
  ...
  oyNamedColor_Release( oyNamedColor_s **namedcolor )
{
  ...
  s = (oyNamedColor_s_*) *namedcolor;

  oyCheckType__m( oyOBJECT_NAMED_COLOR_S, return 1 )

  *namedcolor = 0;

  return oyNamedColor_Release_( &s );
}



/* Include "NamedColor.public_methods_definitions.c" { */
