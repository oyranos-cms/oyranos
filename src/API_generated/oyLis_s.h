 ...
 */
#define oyLis_Copy(lis,object) oyLis_Copy_x(lis,object); if(oy_debug_objects) oyObjectDebugMessage_( lis?lis->oy_:NULL, __func__, "oyLis_s" );
OYAPI oyLis_s* OYEXPORT
  oyLis_Copy_x( oyLis_s *lis, oyObject_s obj );
OYAPI int OYEXPORT
