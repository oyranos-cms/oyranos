...
int myMain( int argc , const char** argv )
{
  ...
  /* type,   flags, o, option, key, name, description, help, value_name, value_type, values, var_type, variable */
    {"oiwi", OYJL_OPTION_FLAG_ACCEPT_NO_ARG, "d", "daemon", NULL, _("daemon"), _("Control user daemon"), NULL, "0|1|2", oyjlOPTIONTYPE_CHOICE, {.choices.list = (oyjlOptionChoice_s*)oyjlStringAppendN( NULL, (const char*)d_choices, sizeof(d_choices), 0 )}, oyjlINT, {.i=&daemon},NULL},
    ...
    {"oiwi", 0, NULL, "sunlight-color-scheme", NULL, _("Sun light color scheme"), _("Set day time typical brighter color scheme"), _("Use this to switch color scheme day/night dependent. plasma-apply-colorscheme --list-schemes"), _("STRING"), oyjlOPTIONTYPE_FUNCTION, {.getChoices = getColorSchemeChoices}, oyjlSTRING, {.s=&sunlight_color_scheme},NULL},
    {"oiwi", 0, NULL, "night-color-scheme", NULL, _("Night color scheme"), _("Set nightly typical darker color scheme"), _("Use this to switch color scheme day/night dependent. plasma-apply-colorscheme --list-schemes"), _("STRING"), oyjlOPTIONTYPE_FUNCTION, {.getChoices = getColorSchemeChoices}, oyjlSTRING, {.s=&night_color_scheme},NULL},
  ...
  /* type,   flags, name, description, help, mandatory, optional, detail */
    ...
    {"oiwg", 0, _("Information"), _("Give Informations"), NULL, "r,m", "v", "r,m",NULL},
    {"oiwg", 0, _("Daemon Service"), _("Run sunset daemon"), NULL, "d", "v", "d",NULL},
    {"oiwg", OYJL_GROUP_FLAG_GENERAL_OPTS, _("Misc"), _("General options"), NULL, "X|h|V|R", "v", "h,X,R,V,z,y,v",NULL},
    {"",0,0,0,0,0,0,0,0}
  };
