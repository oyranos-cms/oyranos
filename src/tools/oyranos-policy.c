...
int myMain( int argc, const char ** argv )
{
  ...
  /* type,   flags, name,               description,                  help,               mandatory,     optional,      detail */
    {"oiwg", 0,     NULL,               _("Current policy"), NULL,               "c",           "f,e,v",       "c",NULL},
    {"oiwg", 0,     NULL,               _("List available policies"), NULL,               "l",           "f,e,v",       "l,f,e",NULL},
    {"oiwg", 0,     NULL,               _("Dump out the actual settings"),NULL,           "d",           "v",           "d",NULL},
    {"oiwg", 0,     NULL,               _("Select active policy"),    NULL,               "i",           "v",           "i",NULL},
    {"oiwg", 0,     NULL,               _("List search paths"),       NULL,               "p",           "v",           "p",NULL},
    {"oiwg", 0,     NULL,               _("Save to a new policy"),    NULL,               "s",           "system-wide,v","s,system-wide",NULL},
    {"oiwg", 0,     NULL,               _("Documentation"),           NULL,               "long-help|docbook","doc-title,doc-version","long-help,docbook,doc-title,doc-version",NULL},
    {"oiwg", OYJL_GROUP_FLAG_GENERAL_OPTS, _("Misc"), _("General options"), NULL,         "X|h|V|R",     "v",           "h,X,R,V,v",NULL},
    {"",0,0,0,0,0,0,0,0}
  };
