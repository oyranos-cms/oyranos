...
MACRO(GETTEXT_CREATE_TRANSLATIONS _potFile _firstPoFileArg)
   ...
   FOREACH (_currentPoFile ${_firstPoFile} ${ARGN})
      ...
      ADD_CUSTOM_COMMAND(
         OUTPUT ${_gmoFile}
         COMMAND ${GETTEXT_MSGMERGE_EXECUTABLE} ${MSGMERGE_OPTS} --update --backup=none -s ${_absFile} ${_absPotFile}
         COMMAND ${GETTEXT_MSGFMT_EXECUTABLE} ${MSGFMT_OPTS} -o ${_gmoFile} ${_absFile}
...
FUNCTION(GETTEXT_PROCESS_POT_FILE _potFile)
   ...
   FOREACH (_lang ${_parsedArguments_LANGUAGES})
      ...
      ADD_CUSTOM_COMMAND(
         OUTPUT "${_poFile}"
         COMMAND ${GETTEXT_MSGMERGE_EXECUTABLE} ${MSGMERGE_OPTS} --update --backup=none -s ${_poFile} ${_absPotFile}
         DEPENDS ${_absPotFile}
      )

      ADD_CUSTOM_COMMAND(
         OUTPUT "${_gmoFile}"
         COMMAND ${GETTEXT_MSGFMT_EXECUTABLE} ${MSGMERGE_OPTS} -o ${_gmoFile} ${_poFile}
...
FUNCTION(GETTEXT_PROCESS_PO_FILES _lang)
   ...
   FOREACH(_current_PO_FILE ${_parsedArguments_PO_FILES})
      ...
      ADD_CUSTOM_COMMAND(OUTPUT ${_gmoFile}
            COMMAND ${GETTEXT_MSGFMT_EXECUTABLE} ${MSGMERGE_OPTS} -o ${_gmoFile} ${_current_PO_FILE}
